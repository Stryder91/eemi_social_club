...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo mr-auto"><a href="index.html">EEMI</a></h1>
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          ...
          <li><a href="#team">Calendrier</a></li>
          <?php 
            if(isset($_SESSION['email'])){
          ?>
          <li><a href="#about">Candidature</a></li>
          ...
          <?php 
            if(!isset($_SESSION['email'])){
          ?>
          <li> <a href="site/register.php" class="get-started-btn white scrollto">Commencer</a></li>
          <?php
            };
          ?>
          <?php 
            if(isset($_SESSION['email'])){
          ?>
          <li><a href="site/deco.php" class="scrollto">Déconnexion</a></li>
          <?php
            };
          ?>
